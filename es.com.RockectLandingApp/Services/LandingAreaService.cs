...
{
    public class LandingAreaService : ILandingAreaService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LandingAreaService"/> class.
        /// </summary>
        /// <param name="positionService">The position service.</param>
        public LandingAreaService(IPositionService positionService)
        {
